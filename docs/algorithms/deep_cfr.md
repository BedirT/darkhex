...
**2x2 CDH** (20 CFR iterations, K=100):
- Exploitability drops from ~1.0 to ~0.04 within 20 iterations
- Comparable to tabular OS-MCCFR at ~50k iterations

**4x3 CDH**: TBD — first neural approach on this board size.
